  ...
  return (
    <div className="bg-black text-white pb-[8rem]" id="">
      <div className="ml-[7rem]">
        ...
        <p className="text-[#D8A206]" data-aos="fade-up">
          I am currently a Senior at Alameda Science and Technology Institute. I
          enjoy programming, hardware, movies and gaming. I can work well with a
          team and by myself. I am eager to working in different types of
