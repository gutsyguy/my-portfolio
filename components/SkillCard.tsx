        ...
        <div className="flex flex-row rounded-2xl mb-10 mx-auto bg-[#001d3d] max-w-2xl w-full transform hover:scale-[1.01] transition-all border-solid border-2 border-[#D8A206]">
          ...
          <div className="flex flex-col w-full">
            <div className="flex bg-[#001d3d] dark:bg-slate-500 rounded-2xl mt-2 mx-2">
              <div
                style={{ width: props.proficiency, backgroundColor: "#D8A206" }}
                className="flex p-[0.1rem] rounded-2xl justify-end"
              >
                <p className="text-[12px] text-[#ffffff] mr-1 font-bold">
                  {props.level}
                </p>
              </div>
            </div>
            <div className="flex p-3 text-white">{props.description}</div>
          </div>
        </div>
      </div>
    </div>
